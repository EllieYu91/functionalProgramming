...
console.log('newPerson 的 lastname属性值是 ', newPerson.lastname, ', person 的 lastname 属性值是 ', person.lastname);
...
console.log(`thirdPerson: ${R.view(zipLens, thirdPerson)}`);
console.log(`person: ${R.view(zipLens, person)}`);
